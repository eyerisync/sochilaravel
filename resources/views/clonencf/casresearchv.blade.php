...
<div class="container" style="padding-top: 30px !important;">
    ...
    <div class="img_container wrapper">
      ...
      <img src="{{asset('plugins/img/department/cas/thumbnails/resbanner1.jpg')}}">
      <div id="story1" class="offset"></div>
      <div id="ccsSignificant"></div>
        <div class="caption p-sm-5 p-4">
        	
        		<!-- August 24, 2019/ Published by: Sheila E. Balid-Bordado -->
        		 <h2><b>Code – Switching in an English Language Classroom Set – Up</b></h2>
        		 <hr>


        		 <p class="text-muted">
              		Researchers: Christina Marie Hegera, Elizabeth Sacayan, Jonnadeth Apuyan and Marc Wence Beldad<br>
              		Adviser: Mr. Dariel A. Palmiano, Ph.D.<br>
              		Year: 2018
              	</p>

         		<h5>Abstract</h5>
              	<p class="lead">
              		 The study determined the perception of the students and teachers in the concept of code-switching in an English Language Classroom Set-up of Naga College Foundation, Inc., College of Arts and Sciences for the academic year 2018-2019. The study aimed to: (1) determine when and why do teachers code-switch; (2) know why the students are code-switching; and (3) identify whether there is a consensus on the responses of the teachers and students. The study was anchored on the Sapir-Whorf Hypothesis or thee Theory of Linguistic Relativity. Respectively, the investigation revealed that teachers are not favorable in the concept of code-switching for it affects the students’ learning and competence toward effective communication. Thus, it provides a cultural practice where students and teachers will develop the mannerism of mixing a language which is not acceptable in the field of work. On the other hand, students prefer the use of code-switching for it caters a foundation of comprehensive self-expression. Moreover, it shoulders the student’s need for broader explanation and it is helpful in the pursuit of effective communication regardless of grammatical structure or preference of Standard English. Nevertheless, the only consensus transcribed was the attainment of global competence wherein if code-switching is practiced, it will hinder their communicational fluency when having a conversation with international personalities. This is the lone consensus and all the responses gathered were all contradictory to each response of the teachers and the students.
              	</p>
		...
		<div class="col-lg-4">
			...
			<h4 class="npanel_header cssBg">CAS Quick Links</h4>
			  <ul class="list-group list-group-flush">
        		...
        		<a href="https://www.ncf.edu.ph/index/oneNcf">
	        		<li class="list-group-item">
