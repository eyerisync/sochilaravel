    ...
    <div class="img_container wrapper">
      <img src="{{asset('plugins/img/department/cas/thumbnails/bannerlogo.jpg')}}">
        <div class="caption p-sm-5 p-4">
        		...
        		<div class="text-muted">Last Updated: September 12, 2019</div>
        		 <h2><b>The College of Arts and Sciences</b></h2>
        		 <hr>


                        <h4>MISSION</h4>
                        <p class="lead">
                          The College of Arts and Sciences fosters excellence in the Arts, Humanities, social and natural sciences, and provides a foundation for intellectual and creative experiences across the Naga College Foundation.
                        </p>

                        <h4>VISION</h4>
                        <p class="lead">
                         It is our purpose to occupy the horizons of knowledge, to extend them, and to ask bold questions that drive exploration forward. We strive to practice and teach learning and discovery as ways of being that enrich lives, solve problems, extend opportunities, and create a better world.
                        </p>
